...
Author-year (natbib) citations are resolved against manuscript/latex/cas-refs.bib,
via the reference_N -> BibTeX-key mapping in manuscript/latex/refkey_to_bibkey.json.
"""
import json
import os
import re
